...
if status is-interactive
  ...
  # legible fish syntax colours.
  set -g fish_color_normal         1e1c0e
  set -g fish_color_command        e2342a
  set -g fish_color_keyword        e83b30
  set -g fish_color_param          3d3a2a
  set -g fish_color_option         5c5840
  set -g fish_color_quote          884f20
  set -g fish_color_redirection    8AA9CC
  set -g fish_color_end            e83b30
  set -g fish_color_error          FF6B6B
  set -g fish_color_comment        7d7858
  set -g fish_color_operator       924900
  set -g fish_color_escape         924900
  set -g fish_color_autosuggestion 7d7858
