...
Item {
    ...
    Row {
        ...
        UiText {
            anchors.verticalCenter: parent.verticalCenter
            text: "信"; color: Theme.primary
            font.family: "Noto Sans CJK JP"; font.pixelSize: 13
        }
        UiText { anchors.verticalCenter: parent.verticalCenter; text: Config.name ? Config.name.toUpperCase() : "AMTIA"; color: hdr.root.ink; font.family: hdr.root.mono; font.pixelSize: 10; font.letterSpacing: 2; font.weight: Font.Medium }
    ...
    Row {
        ...
        Row {
            anchors.verticalCenter: parent.verticalCenter
            spacing: 6
            Rectangle { anchors.verticalCenter: parent.verticalCenter; width: 6; height: 6; radius: 3; color: Theme.primary }
