...
Item {
    ...
    readonly property bool streamLive: active
    onStreamLiveChanged: {
    ...
    readonly property int fullMotionTick: 16  // fast positional motion (60fps)
    readonly property int driftTick: 16       // smooth crawl (60fps)
    readonly property int chargeTick: 16      // smooth field (60fps)
    readonly property int watchTick: 60       // responsive watch
