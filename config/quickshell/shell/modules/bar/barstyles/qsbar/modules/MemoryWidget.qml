...
Item {
    ...
    readonly property color contentColor: root.widgetContentColor("G4", dynamicColor)
    readonly property string usedLabel: String(Math.round(usedGiB)).padStart(2, "0") + "G"
    readonly property string tooltipText: "RAM · " + usedGiB.toFixed(1) + "/" + totalGiB.toFixed(0) + " GiB (" + rootMod.percent + "%)"
