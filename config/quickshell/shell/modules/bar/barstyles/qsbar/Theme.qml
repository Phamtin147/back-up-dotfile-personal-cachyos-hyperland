...
Item {
    ...
    function applyAnchor(name, x) {
        ...
        else if (name === "docker") dockerBarX = x
    }
    ...
    function closePopups(except) {
        ...
        if (except !== "dockerVisible") dockerVisible = false
        hideTooltip()
    ...
    function iconOnly(gid) { var d = ["G4", "G5", "G6", "G7", "G12", "G13", "G14", "G16", "G17", "G18"]; if (d.indexOf(gid) >= 0) return true; return iconOnlyGids.indexOf(gid) >= 0; }
    ...
    readonly property var launcherLogoIconCodes: ({
        "ryoku": 0x4FE1, "hyprland": 0xF359, "arch": 0xE732, "grid": 0xEEED, "spark": 0xE6A4, "power": 0xF011, "dragon": 0x2EEF, "mark": 0xEE99, "nix": 0xF313, "branch": 0xE666, "rebel": 0xF1D0,
    ...
    function persistWidgetsToConfig() {
        ...
        q.widgets = {
            ...
            "battery": modBattery, "docker": modDocker
        }
    ...
    function applyStudioSettings() {
        ...
        if (w) {
            ...
            if (w.docker         !== undefined) modDocker         = w.docker
        }
        _widgetsLoaded = wl
    }
    Connections {
    ...
    property bool dockerVisible:    false
    onDockerVisibleChanged: popupOpened("dockerVisible")
    ...
    property real dockerBarX:     0
    property var  dockerContainers: []
    property int  dockerRunningCount: 0
    property bool dockerDaemonActive: false
