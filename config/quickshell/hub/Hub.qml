...
Rectangle {
    ...
    readonly property var defs: ({
        ...
        "markText": "信", "markImage": "", "markTint": true, "name": "Ryoku",
        ...
        Column {
            ...
            Rectangle {
                ...
                Row {
                    ...
                    spacing: Tokens.s3
                    Text { text: "信"; color: Tokens.ink; font.family: Tokens.jp; font.pixelSize: 22 }
                    Column {
                        spacing: 1
    ...
    Item {
        ...
        Column {
            ...
            Row {
                ...
                Text { text: "信"; color: Tokens.ink; font.family: Tokens.jp; font.pixelSize: 11; anchors.verticalCenter: parent.verticalCenter }
                Text {
